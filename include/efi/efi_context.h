...
#define EFI_CONV_POOL_SIZE    SIZE_4GB
#define EFI_BS_CODE_POOL_SIZE SIZE_4GB
#define EFI_BS_DATA_POOL_SIZE SIZE_4GB
#define EFI_LD_CODE_POOL_SIZE SIZE_64MB
#define EFI_LD_DATA_POOL_SIZE SIZE_64MB
